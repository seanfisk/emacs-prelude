...
* TODO [#A] Check out main-line or powerline.
* TODO [#A] Add or change prefix keys for right and left arrow. See tips file for how.
* TODO [#A] Get projectile to obey the .gitignore file.
* TODO [#A] Add Melpa package restrictions back.
* TODO [#B] Upgrade and test with Emacs 24.3.
...
* TODO [#C] Write a function that unfills the paragraph or region.
  - Based on =unfill.el=.
